...
export function Navbar() {
  ...
  return (
    <>
      <nav className={cn(
        "sticky top-0 z-40 w-full transition-all duration-300 bg-white border-b border-gray-100 shadow-[0_2px_12_px_-4px_rgba(0,0,0,0.05)]"
      )}>
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4">
          ...
          {!isCatalog && (
            <form onSubmit={handleSearch} className="flex-1 max-w-2xl relative group hidden md:block">
              <div className="flex items-center gap-2">
                ...
                />
                <button type="submit" className="h-10 px-5 rounded-lg bg-brand text-white text-sm font-bold hover:bg-brand/90 transition-colors flex items-center gap-2">
